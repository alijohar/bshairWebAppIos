...
class NewsDetailPush: UIViewController, UIWebViewDelegate {
...
//            ])
        ...
        fetchDataSinglePost(id: newsItemId)
...
//        For style
    ...
    func fetchDataSinglePost(id:Int){
        NewsApi.getSinglePost(post_id: Int(id)) { (error:Error?, newsSinglePost: NewsPost?) in
            self.navTitle = newsSinglePost!.title
            self.author = newsSinglePost!.author?.name
                self.newsItemId = newsSinglePost!.id!
            self.cat = newsSinglePost!.categories!
            self.date = newsSinglePost!.date
            self.numberComments = newsSinglePost!.commentCount
            self.newsUrlLink = newsSinglePost!.url!
            self.contentNewsDetail = newsSinglePost!.content!
            self.newsImageUrlString = newsSinglePost!.thumbnailImages?.mediumLarge?.url
            self.comments = newsSinglePost!.comments!
